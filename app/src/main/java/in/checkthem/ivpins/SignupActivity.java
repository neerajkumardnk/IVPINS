...
import static in.checkthem.ivpins.EndPoints.URL_REGISTER_DEVICE;
import static in.checkthem.ivpins.R.id.editTextVehicleNumber;
...
public class SignupActivity extends AppCompatActivity {
                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    startActivity(new Intent(SignupActivity.this, SendPushNotification.class));
    ...
    private void sendToFdb(){
        ...
        vehicleRef.child("vehicle").setValue(""+vehicle);
        ...
        reference.child(""+vehicle).setValue(""+Token);
